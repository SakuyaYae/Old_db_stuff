...
loadSqlIntoSkolan "user" "pass" "ddl_all.sql"
loadSqlIntoSkolan "user" "pass" "insert.sql" "Insert into larare" "Alter table larare"
loadSqlIntoSkolan "user" "pass" "dml_update_lonerevision.sql" "Utför lönerevision"
loadSqlIntoSkolan "user" "pass" "dml_insert_csv.sql"
loadSqlIntoSkolan "user" "pass" "dml_join2.sql"
